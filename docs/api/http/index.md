...
| 接口 | 说明 |
|---|---|
| [`/wallet/freezebalance`](stake-v1/freezebalance.md) | 冻结 TRX 获取资源（V1） |
| [`/wallet/unfreezebalance`](stake-v1/unfreezebalance.md) | 解冻已到期资源（V1） |
| [`/wallet/getdelegatedresource`](stake-v1/getdelegatedresource.md) | 查询代理记录（V1） |
| [`/wallet/getdelegatedresourceaccountindex`](stake-v1/getdelegatedresourceaccountindex.md) | 查询代理对手地址（V1） |

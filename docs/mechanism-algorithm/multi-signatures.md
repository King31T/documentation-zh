...
| 26 | ExchangeTransactionContract | ExchangeContract.ExchangeTransactionContract | ExchangeTransactionActuator | 🚫 禁用(v4.8.0.1 分叉后由 `Manager.java` 硬编码拒绝,PR [#6507](https://github.com/tronprotocol/java-tron/pull/6507),不走链参数) | 通过 Bancor 交易对进行资产兑换 |
